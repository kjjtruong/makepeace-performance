        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12 mt-20">
            ...
            <div className="lg:order-first lg:row-span-2">
              ...
              <h4 className="mt-2 text-base font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:base">
                Founder & Coach
              </h4>
              <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
                ...
                <div>
                  ...
                  <ul className="mt-4">
                    <li className="flex">
                      <a
                        className="text-sm font-medium text-zinc-800 transition hover:text-orange-500 dark:text-zinc-200 dark:hover:text-orange-500 underline underline-offset-4"
                  ...
                  <ul className="mt-4">
                    <li className="flex">
                      ...
                      >
                        ...
                        <span className="ml-4 underline underline-offset-4">Read Substack Newsletter</span>
                      </a>
                    </li>
                    <li className="mt-4 flex">
                      ...
                      >
                        ...
                        <span className="ml-4 underline underline-offset-4">tyler@tcmperformance.ca</span>
                      </a>
                    </li>
                    <li className="mt-4 flex">
                      <a
                      ...
                      >
                        ...
                        <span className="ml-4 underline underline-offset-4">Follow on Twitter</span>
                      </a>
                    </li>
                    <li className="mt-4 flex">
                      <a
                      ...
                      >
                        ...
                        <span className="ml-4 underline underline-offset-4">Follow on Instagram</span>
                      </a>
                    </li>
                    <li className="mt-4 flex">
                      <a
                      ...
                      >
                        ...
                        <span className="ml-4 underline underline-offset-4">Follow on TikTok</span>
                      </a>
                    </li>
                  </ul>
                </div>
