              ...
              <div className="mt-6 space-y-7 text-lg text-zinc-600 dark:text-zinc-400">
                ...
                <div>
                  ...
                  <ul className="mt-4">
                    <li className="flex">
                      <a
                        className="text-base font-medium text-zinc-600 transition hover:text-orange-500 dark:text-zinc-200 dark:hover:text-orange-500 underline underline-offset-4"
                ...
                <div>
                  ...
                  <ul className="mt-4">
                    <li className="flex">
                      <a
                        className="group flex text-base font-medium text-zinc-600 transition hover:text-orange-500 dark:text-zinc-200 dark:hover:text-orange-500"
                    ...
                    <li className="mt-4 flex">
                      <a
                        className="group flex text-base font-medium text-zinc-800 transition hover:text-orange-500 dark:text-zinc-200 dark:hover:text-orange-500"
